...
main(int argc, char *argv[])
{
  ...
  18:	4509                	li	a0,2
  1a:	6c2000ef          	jal	ra,6dc <fprintf>
    exit(1);
  1e:	4505                	li	a0,1
  ...
  44:	4509                	li	a0,2
  46:	696000ef          	jal	ra,6dc <fprintf>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3ca:	51250513          	addi	a0,a0,1298 # 8d8 <digits>
 3ce:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48a:	452c8c93          	addi	s9,s9,1106 # 8d8 <digits>
 ...
 6ae:	22690913          	addi	s2,s2,550 # 8d0 <malloc+0x110>
        for(; *s; s++)
